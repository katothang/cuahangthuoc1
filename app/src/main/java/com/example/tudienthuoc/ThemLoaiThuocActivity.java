...
public class ThemLoaiThuocActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_them_loai_thuoc);
    ...
    private void themThuoc(Thuoc thuoc)
    {
        ...
        DatabaseReference myRef = database.getReference("LoaiThuoc/"+ SystemClock.currentThreadTimeMillis());
        myRef.setValue(thuoc);
        Toast.makeText(this, "Thêm thành công loại thuốc", Toast.LENGTH_SHORT).show();
    }
}
