...
public class ThemThuocActivity extends AppCompatActivity {
    ...
    private void themThuoc(Thuoc thuoc)
    {
        ...
        DatabaseReference myRef = database.getReference("Thuoc/"+ SystemClock.currentThreadTimeMillis());
        myRef.setValue(thuoc);
        Toast.makeText(this, "Thêm thành công thuốc", Toast.LENGTH_SHORT).show();
    }
}
