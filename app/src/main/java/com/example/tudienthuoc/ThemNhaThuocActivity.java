...
public class ThemNhaThuocActivity extends AppCompatActivity {
    ...
    private void them(Thuoc thuoc)
    {
        ...
        DatabaseReference myRef = database.getReference("NhaThuoc/"+ SystemClock.currentThreadTimeMillis());
        myRef.setValue(thuoc);
        Toast.makeText(this, "Thêm thành công nhà thuộc", Toast.LENGTH_SHORT).show();
    }
}
