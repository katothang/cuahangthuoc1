...
public class ThemCongTyDuocActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_them_cong_ty_duoc);
    ...
    private void themThuoc(Thuoc thuoc)
    {
        ...
        DatabaseReference myRef = database.getReference("CongTyDuoc/"+ SystemClock.currentThreadTimeMillis());
        myRef.setValue(thuoc);
        Toast.makeText(this, "Thêm thành công Công Ty Dược", Toast.LENGTH_SHORT).show();
    }
}
